class THKMC_GameData17 extends THKMC_GameDataBase {
	__New( ) {
		base.__New("th17", "东方鬼形兽 1.00b", 0x5D4E902C, 747520)
		pd = 
(LTrim Comment
57               ; PUSH EDI
87E5 ; xchg ebp,esp
81c5 10010000 ; add ebp, 110
...
81ed 10010000 ; sub ebp, 110
87E5 ; xchg ebp,esp
5F              ; POP EDI
	)
		this._setPatchData( 0x401c8f, 0x401dea, 0x400c00, 0x104, pd )
	}
}
